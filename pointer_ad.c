...
{   
    ...
    int numCopy = *ptr;
    // numCopy -> address = 0x3, value = 12, data-type = int      | New
    // ptr -> address = 0x2, value = 0x1, data-tyoe = int *       | Same as above
    // num -> address = 0x1, value = 12, data-type = int          | Same as above
    
    num = 15;
    // num -> address = 0x1, value = 15, data-type = int          | Change
    // numCopy -> address = 0x3, value = 12, date-type = int      | Same as above
    // ptr -> address = 0x2, value = 0x1, data-tyoe = int *       | Same as above
    
    *ptr = 10;
    // ptr -> address = 0x2, value = 0x1, data-type = int *       | Same as above
    // num -> address = 0x1, value = 10, data-type = int          | Change
    // numCopy -> address = 0x3, value = 12, date-type = int      | Same as above
    
    ptr = &numCopy;
    // ptr -> address = 0x2, value = 0x3, data-type = int *       | Change
    // num -> address = 0x1, value = 10, data-type = int          | Same as above
    // numCopy -> address = 0x3, value = 12, date-type = int      | Samw as above
    
    num = *ptr;
    // ptr -> address = 0x2, value = 0x3, data-type = int *       | ame as above
    // num -> address = 0x1, value = 12, data-type = int          | Change
    // numCopy -> address = 0x3, value = 12, date-type = int      | Same as above
    ...
    int *num2 = *ptr2;
    // num2 -> address = 0x6, value = 0x3, data-type = int *      | New
